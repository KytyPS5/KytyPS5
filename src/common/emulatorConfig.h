...
constexpr uint32_t HOST_INPUT_MAPPING_VERSION = 2;
...
struct ConfigOptions {
	std::string            input_profile                   = "default";
...
bool ValidateKeymapEntry(const std::string& entry, std::string* error = nullptr);
