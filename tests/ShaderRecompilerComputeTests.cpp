...
public:
  ...
  void CheckGpuCommandLane() {
    ...
    gpu.SendCommandSync([&] {
      ...
      Require("GpuCommandLane", "generic context",
              !Gpu::IsCommandProcessorThread() &&
                  Gpu::CurrentCommandProcessor() == nullptr,
    ...
    gpu.SendCommandSyncWithProcessor([&](CommandProcessor &processor) {
      Require(
          "GpuCommandLane", "processor context",
          Gpu::IsCommandProcessorThread() &&
    ...
    gpu.SendCommandSyncWithProcessor([&](CommandProcessor &) {
      ...
      Require("GpuCommandLane", "clean cached setup",
              buffer_cache.HasPageOverlap(clean_cached_fill,
                                          sizeof(source_words)) &&
  ...
  void CheckBufferCacheDirtyGarbageCollection() {
...

    {
      ...
      Require(name, "age before pressure",
              cache.HasPageOverlap(base, allocation_size),
      ...
      Require(name, "direct-unmap contents",
              unmap_backing == unmap_value &&
                  !cache.HasPageOverlap(base + 0x4000, 0x4000),
      ...
      auto [survivor, survivor_offset] =
          cache.ObtainBufferForImageWrite(base + partial_unmap_survivor_offset,
                                          sizeof(partial_unmap_survivor_value));
      ...
      Require(name, "per-owner fixed-ring retirement",
              !cache.HasPageOverlap(base + grouped_first_offset,
                                    grouped_owner_size) &&
                  !cache.HasPageOverlap(base + grouped_second_offset,
                                        grouped_owner_size) &&
                  &BufferCacheTestAccess::DownloadBuffer(cache) ==
                      fixed_download &&
                  fixed_download->Handle() == fixed_download_handle,
      ...
      Require(name, "disjoint deferred retirement",
              !cache.HasPageOverlap(base + disjoint_owner_offset,
                                    disjoint_owner_size),
      ...
      Require(name, "disjoint publication-gated unmap",
      ...
      cache.DiscardGpuDirtyBytes(base + disjoint_new_owner_offset,
                                 sizeof(disjoint_value));
      ...
      Require(name, "reacquire deferred retirement",
              !cache.HasPageOverlap(base + reacquire_owner_offset,
      ...
      cache.DiscardGpuDirtyBytes(base + reacquire_disjoint_offset,
                                 sizeof(reacquire_value));
  ...
  void CheckUnifiedTextureCacheFlow() {
...

    {
      ...
      auto MakeLinearDesc = [&](uint64_t address, uint64_t size,
                                vk::Format format, uint32_t guest_format,
                                Prospero::ImageType type, vk::Extent3D extent,
                                uint32_t layers, uint32_t bytes_per_block,
                                uint32_t samples) {
        ImageDesc desc{};
      ...
      auto array_desc = MakeLinearDesc(
          base + 0x1000, sizeof(volume_values), vk::Format::eR32Uint,
      ...
      Require(
          name, "Image-owned 2D-array/3D copy state",
      ...
      auto [ms_stencil_owner, ms_stencil_owner_offset] =
          resources.GetBufferCache().ObtainBufferForImageWrite(
      ...
      Require(name, "oversized multisample download rejection",
              oversized_ms_readback && oversized_ms_mirror &&
                  oversized_ms.IsGpuModified() &&
      ...
      auto color_desc_4x = MakeLinearDesc(
          base + 0x7000, sizeof(multisample_source_4x),
      ...
      auto mirror_desc = MakeLinearDesc(
          base + 0x5000, sizeof(mirror_value), vk::Format::eR32Uint,
          Prospero::GpuEnumValue(Prospero::BufferFormat::k32UInt),
          Prospero::ImageType::kColor2D, {1, 1, 1}, 1, 4, 1);
      ...
      Require(name, "image-to-buffer mirror",
              texture_cache.SynchronizeImageToBuffer(base + 0x5000,
                                                     sizeof(mirror_value)) &&
      ...
      auto exact_buffer_desc = MakeLinearDesc(
          base + exact_buffer_offset, sizeof(exact_buffer_value),
          vk::Format::eR32Uint,
          Prospero::GpuEnumValue(Prospero::BufferFormat::k32UInt),
          Prospero::ImageType::kColor2D, {1, 1, 1}, 1, 4, 1);
      ...
      Require(name, "exact replacement Buffer publication",
              texture_cache.SynchronizeImageToBuffer(
                  exact_buffer_desc.info.data.address,
      ...
      Require(name, "partial-page clean source",
              partial_clean_source.buffer != nullptr &&
                  !partial_clean_source.gpu_owned,
      ...
      auto fault_a_desc = MakeLinearDesc(
          base + 0x8000, sizeof(fault_a), vk::Format::eR32Uint,
          Prospero::GpuEnumValue(Prospero::BufferFormat::k32UInt),
          Prospero::ImageType::kColor2D, {1, 1, 1}, 1, 4, 1);
      ...
      Require(name, "exact-disjoint buffer allocation",
              publish_buffer_owner != nullptr,
      ...
      auto partial_unmap_image = MakeLinearDesc(
          base + partial_unmap_image_offset, 0x2000, vk::Format::eR32Uint,
          Prospero::GpuEnumValue(Prospero::BufferFormat::k32UInt),
      ...
      Require(name, "partial image unmap tracking",
              partial_unmap_image_id &&
                  ...
                  !texture_cache.InvalidateMemory(
                      ...
                      partial_unmap_image.info.data.address + 0x1000, 0x1000,
      ...
      auto unformatted_alias = MakeLinearDesc(
          base + unformatted_alias_offset, sizeof(uint32_t),
          vk::Format::eR32Uint,
          Prospero::GpuEnumValue(Prospero::BufferFormat::k32UInt),
          Prospero::ImageType::kColor2D, {1, 1, 1}, 1, 4, 1);
      ...
      const auto layered_layout = TextureCalcUploadLayout(
          ...
          2, Prospero::GpuEnumValue(Prospero::TileMode::kLinear),
          layered_guest_size, true, false, "UnifiedTextureCacheFlow");
      ...
      auto replacement_source = MakeLinearDesc(
          base + replacement_offset, sizeof(uint32_t), vk::Format::eR32Uint,
          Prospero::GpuEnumValue(Prospero::BufferFormat::k32UInt),
          Prospero::ImageType::kColor2D, {1, 1, 1}, 1, 4, 1);
      ...
      auto replacement_desc = MakeLinearDesc(
          base + replacement_offset, replacement_size, vk::Format::eR32Uint,
          Prospero::GpuEnumValue(Prospero::BufferFormat::k32UInt),
          Prospero::ImageType::kColor2D, {1, 1, 1}, 2, 4, 1);
      ...
      Require(name, "compressed download rejection",
              !TextureCacheTestAccess::TryDownload(texture_cache,
                                                   compressed_image) &&
                  !texture_cache.SynchronizeImageToBuffer(
                      compressed_desc.info.data.address,
      ...
      auto [mixed_owner, mixed_owner_offset] =
          resources.GetBufferCache().ObtainBufferForImageWrite(
              base + mixed_source_offset, mixed_source_size);
      ...
      auto byte_mirror_desc = MakeLinearDesc(
          base + byte_mirror_offset, 1, vk::Format::eR8Unorm,
      ...
      Require(name, "byte image fault contents",
              byte_mirror_backing == byte_mirror_guest,
      ...
      Require(
          name, "partial-page CPU refresh content",
      ...
      resources.GetBufferCache().FillBuffer(base + dirty_sibling_offset,
                                            ...
                                            dirty_sibling_value);
      auto exact_image_desc = MakeLinearDesc(
          base + exact_image_offset, sizeof(uint32_t), vk::Format::eR32Uint,
          Prospero::GpuEnumValue(Prospero::BufferFormat::k32UInt),
          Prospero::ImageType::kColor2D, {1, 1, 1}, 1, 4, 1);
      ...
      resources.GetBufferCache().DiscardGpuDirtyBytes(
          base + dirty_sibling_offset, sizeof(dirty_sibling_value));
      ...
      auto gc_image_desc_a = MakeLinearDesc(
          base + gc_image_offsets[0], sizeof(uint32_t), vk::Format::eR32Uint,
          Prospero::GpuEnumValue(Prospero::BufferFormat::k32UInt),
          Prospero::ImageType::kColor2D, {1, 1, 1}, 1, 4, 1);
      ...
      tiled_depth_desc.info.tile_mode =
      ...
      auto large_desc = MakeLinearDesc(
          ...
          Prospero::GpuEnumValue(Prospero::BufferFormat::k8_8_8_8UNorm),
          Prospero::ImageType::kColor2D, {large_width, large_height, 1}, 1, 4,
          1);
  ...
  void CheckBgra16Readback() {
    ...
    scheduler.Begin(registers, user_config, shaders);
    {
      ...
      Require(name, "Buffer mirror",
              cache.SynchronizeImageToBuffer(base, total.size),
              "tiled BGRA16 Buffer mirror was rejected");

      auto mirror = resources.GetBufferCache().ObtainBuffer(
          scheduler.Current(), base, 8, false, true);
  ...
  void CheckRenderExecutorStencilBindingDiscovery() {
...

    {
      ...
      const auto stencil_pitch =
          TileGetTexturePitch(stencil_format, 1, 1, linear);
      TileSizeAlign stencil_layout{};
      TileGetTextureTotalSize(stencil_format, 1, 1, 1, stencil_pitch, 1, linear,
                              false, stencil_layout);
      ...
      msaa_array_texture.fields[3] =
          ...
          (Prospero::GpuEnumValue(Prospero::ImageType::kColor2DMsaaArray)
           << 28u);
  ...
  void CheckGpuTilerCpuParity() {
...

    {
      ...
      const auto regions = TextureBuildImageCopies(layout, width, height,
                                                   layers, 1, true, false);
      std::vector<GpuTileInfo> infos;
    ...
    for (const auto &mode : standard_modes) {
      ...
      const auto layout =
          TextureCalcUploadLayout(format, width, height, levels, 1, pitch,
                                  mode.tile, total.size, false, false, name);
      const auto regions = TextureBuildImageCopies(layout, width, height, 1,
                                                   levels, false, false);
      std::vector<GpuTileInfo> infos;
...

    {
      ...
      const auto regions = TextureBuildImageCopies(layout, width, height, depth,
                                                   levels, false, true);
      std::vector<GpuTileInfo> infos;
      const bool built = TextureBuildGpuTileInfos(total.size, regions, layout,
...

    {
      ...
      const u32 pitch = TileGetTexturePitch(format, width, levels, tile);
      TileSizeAlign total{};
      TileGetTextureSize(format, width, height, pitch, levels, tile, &total,
                         nullptr, nullptr);
      const auto layout =
          TextureCalcUploadLayout(format, width, height, levels, 1, pitch, tile,
    ...
    constexpr u32 volume_format =
        Prospero::GpuEnumValue(Prospero::BufferFormat::k32UInt);
    constexpr u32 volume_tile =
        Prospero::GpuEnumValue(Prospero::TileMode::kLinear);
    constexpr u32 volume_width = 8, volume_height = 4, volume_depth = 5;
    constexpr u32 volume_levels = 3;
    const u32 volume_pitch = TileGetTexturePitch(volume_format, volume_width,
                                                 volume_levels, volume_tile);
    TileSizeAlign volume_size{};
    TileGetTextureTotalSize(volume_format, volume_width, volume_height,
                            volume_depth, volume_pitch, volume_levels,
                            volume_tile, true, volume_size);
    const auto volume_layout = TextureCalcUploadLayout(
        volume_format, volume_width, volume_height, volume_levels, volume_depth,
        volume_pitch, volume_tile, volume_size.size, true, true, name);
    const auto volume_copies =
        TextureBuildImageCopies(volume_layout, volume_width, volume_height,
                                volume_depth, volume_levels, false, true);
    ...
    for (u32 level = 0; level < volume_levels; level++) {
      volume_info.mip_layout[level] = {
          volume_layout.level_sizes[level].offset,
          volume_layout.level_sizes[level].size,
          volume_layout.padded_sizes[level].width,
          volume_layout.padded_sizes[level].height};
    }
...
void CheckStorageTextureLinearUploadLayout() {
  ...
  const auto regions =
      TextureBuildImageCopies(layout, width, height, depth, 1, false, false);
...
void CheckStorageTextureDepthTileUploadLayout() {
  ...
  const auto regions =
      TextureBuildImageCopies(layout, width, height, depth, 1, true, false);
...
void CheckStorageTextureVolumeUploadLayout() {
  ...
  const auto regions =
      TextureBuildImageCopies(layout, width, height, depth, 1, false, true);
...
void CheckStorageTextureVolumeMipRegions() {
  ...
  const auto copies = TextureBuildImageCopies(layout, width, height, depth,
                                              levels, false, true);
