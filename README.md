...
The guest graphics architecture is based on AMD RDNA 2. Use AMD's
...
- [`src/graphics/guest_gpu`](src/graphics/guest_gpu) — guest GPU formats and command processing
