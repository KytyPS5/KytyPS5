...
последнем измерительном запуске `223812-1388a0` счётчик дошёл до frame 19,
эмулятор подготовил 7 GPU flips и показал 6. Проверочный readback соседнего
...
по-прежнему занимает около 6,1 с. Изображение осталось чёрным.
...
| Каталог последнего запуска | `_Build/runs/yotei-integrated-20260906-223812-1388a0` |
| SHA-256 запущенного emulator | `a830d293ec096df796fa96fdc7a8600230d058a42bd9cd3f5b162fe7218a5c87` |
| Время UTC | `2026-09-06T22:38:13.0304728Z` → `22:39:13.6392128Z` |
...
| Наблюдаемое исполнение | frame 19; FPS 0,109889; flips CPU/GPU 0/7; prepared 7, ready 7, shown 6 |
| Изображение | Чёрное. Отдельный readback двух source frames 1920×1080: RGB min=max=0, alpha=3 |
| Главные bottlenecks | `916ea8893e5b276a` ≈6,13 с; `e52e19c6923301d0` снижен до ≈13,9–15,6 мс steady (первый вызов ≈3,11 с с созданием pipeline) |
| Точность состояния | `e52e…` имеет 176 structured CFG blocks, 221 088 SPIR-V words до optimizer, без optimizer/structured ошибки; полный batch остался 714/825 |
