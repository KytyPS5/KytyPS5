...
constexpr VopcOpcodeInfo VOPC_OPCODE_LIST[] = {
    ...
    {0xbau, Opcode::V_CMPX_EQ_U16},        {0xbcu, Opcode::V_CMPX_GT_U16},
    ...
    {0xf2u, Opcode::V_CMPX_EQ_U64, false}, {0xf5u, Opcode::V_CMPX_NE_U64, false},
...
constexpr Vop1SdwaRule VOP1_SDWA_RULES[] = {
    ...
    {Opcode::V_NOT_B32, SdwaSelBytes() | SdwaSelWords() | SdwaSelFull(),
